...
#define CCU6_1_CH1_INT_SERVICE  IfxSrc_Tos_cpu2
...
#define UART0_TX_INT_PRIO       13                  // 定义串口0发送中断优先级 优先级范围1-255 越大优先级越高 与平时使用的单片机不一样
#define UART0_RX_INT_PRIO       14                  // 定义串口0接收中断优先级 优先级范围1-255 越大优先级越高 与平时使用的单片机不一样
#define UART0_ER_INT_PRIO       15                  // 定义串口0错误中断优先级 优先级范围1-255 越大优先级越高 与平时使用的单片机不一样

#define UART1_INT_SERVICE       IfxSrc_Tos_cpu1
#define UART1_TX_INT_PRIO       43
#define UART1_RX_INT_PRIO       74
#define UART1_ER_INT_PRIO       45

#define UART2_INT_SERVICE       IfxSrc_Tos_cpu1
#define UART2_TX_INT_PRIO       19
#define UART2_RX_INT_PRIO       20
#define UART2_ER_INT_PRIO       21

#define UART3_INT_SERVICE       IfxSrc_Tos_cpu1
#define UART3_TX_INT_PRIO       16
#define UART3_RX_INT_PRIO       17
#define UART3_ER_INT_PRIO       18
